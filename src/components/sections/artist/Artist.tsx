...
const Artist = () => {
	...
	return (
		<section ref={ref} id="artist">
			<div className="mx-auto px-20 md:px-40">
				<h1 className="py-4 text-2xl">Meet Máté Ilona — A Lifelong Dream Turned Reality</h1>
				...
				<p className="text-pretty">
					...
					knot. Her work is not just decorative—it's personal. Every bracelet, necklace, and wall hanging reflects the
					joy of someone who finally gets to do what she truly loves.
				</p>
				<p className="text-pretty">
